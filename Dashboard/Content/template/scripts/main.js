...
(function ($) {
    ...
    $('<div class="configuration layout-column flex hidden-sm-down"> ' +
        '<div class="configuration-cog toggle-options"> ' +
        ...
        '</div> ' +
        '<div class="configuration-options flex scroll-y"> ' +
        '<div class="title"> Layouts </div> <div class="row text-xs-center options"> <div class="col-xs-6"> <a href="index.html"> <img src="~/Content/template/images/layouts/default.png" class="img-fluid"> </a> <div class="m-b-2">Default</div> </div> <div class="col-xs-6"> <label> <input name="offcanvas" type="checkbox"/> <i class="material-icons">check</i> <img src="~/Content/template/images/layouts/offcanvas.png" class="img-fluid"> </label> <div class="m-b-2">Offcanvas Sidebar</div> </div> <div class="col-xs-6"> <label> <input name="expanding" type="checkbox"/> <i class="material-icons">check</i> <img src="~/Content/template/images/layouts/expanding.png" class="img-fluid"> </label> <div class="m-b-2">Expanding Sidebar</div> </div> <div class="col-xs-6"> <label> <input name="fixed-header" type="checkbox"/> <i class="material-icons">check</i> <img src="~/Content/template/images/layouts/default.png" class="img-fluid"> </label> <div class="m-b-2">Fixed header</div> </div> <div class="col-xs-6"> <label> <input name="boxed" type="checkbox"/> <i class="material-icons">check</i> <img src="~/Content/template/images/layouts/boxed.png" class="img-fluid"> </label> <div class="m-b-2">Boxed Wrapper</div> </div> <div class="col-xs-6"> <label> <input name="static" type="checkbox"/> <i class="material-icons">check</i> <img src="~/Content/template/images/layouts/default.png" class="img-fluid"> </label> <div class="m-b-2">Static Sidebar</div> </div> <div class="col-xs-6"> <label> <input name="search-focus-active" type="checkbox"/> <i class="material-icons">check</i> <img src="~/Content/template/images/layouts/default.png" class="img-fluid"> </label> <div class="m-b-2">Expanding Search</div> </div> <div class="col-xs-6"> <a href="index-horizontal.html"> <img src="~/Content/template/images/layouts/horizontal.png" class="img-fluid"> </a> <div class="m-b-2">Horizontal Nav</div> </div> </div> <div class="option text-uppercase m-t-2"> Example Skins </div> <div class="row"> <div class="col-xs-6"> <div class="theme-options"> <label> <input name="theme-choice" type="radio" value="skin-default"> <i class="material-icons"> check </i> <div> <span> <span class="bg-white"> </span> <span class="bg-white"> </span> </span> <span class="bg-primary"> </span> </div> </input> </label> </div> </div> <div class="col-xs-6"> <div class="theme-options"> <label> <input name="theme-choice" type="radio" value="skin-1"> <i class="material-icons"> check </i> <div> <span> <span class="bg-white"> </span> <span class="bg-white"> </span> </span> <span class="bg-success"> </span> </div> </input> </label> </div> </div> <div class="col-xs-6"> <div class="theme-options"> <label> <input name="theme-choice" type="radio" value="skin-2"> <i class="material-icons"> check </i> <div> <span> <span class="bg-white"> </span> <span class="bg-white"> </span> </span> <span class="bg-info"> </span> </div> </input> </label> </div> </div> <div class="col-xs-6"> <div class="theme-options"> <label> <input name="theme-choice" type="radio" value="skin-3"> <i class="material-icons"> check </i> <div> <span> <span class="bg-white"> </span> <span class="bg-white"> </span> </span> <span class="bg-warning"> </span> </div> </input> </label> </div> </div> <div class="col-xs-6"> <div class="theme-options"> <label> <input name="theme-choice" type="radio" value="skin-4"> <i class="material-icons"> check </i> <div> <span> <span class="bg-dark"> </span> <span class="bg-dark"> </span> </span> <span class="bg-primary"> </span> </div> </input> </label> </div> </div> </div> </div> </div>').appendTo('body');
    $('.configuration').on('click', '.toggle-options', function (e) {
        e.stopPropagation();
        e.preventDefault();
        $('.configuration').toggleClass('active');
    });
    $('.configuration').on('change', 'input[type="checkbox"]', function (e) {
        var name = $(this).attr('name');
        if (name !== 'search-focus-active') {
            if (name === 'offcanvas' && $(this).is(':checked') && $('.app').hasClass('expanding')) {
                $('.app').removeClass('expanding');
                $('input[name="expanding"]').prop('checked', false);
            }
            if (name === 'expanding' && $(this).is(':checked') && $('.app').hasClass('offcanvas')) {
                $('.app').removeClass('offcanvas');
                $('input[name="offcanvas"]').prop('checked', false);
            }
            if ($(this).is(':checked')) {
                $('.app').addClass(name);
            } else {
            ...
            if ($(this).is(':checked')) {
                $('.header-inner').addClass(name);
            } else {
                $('.header-inner').removeClass(name);
            }
        }
    ...
    $('.configuration').on('change', 'input[type="radio"]', function (e) {
        var value = $(this).val();
