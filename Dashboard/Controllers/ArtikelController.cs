...
namespace Dashboard.Controllers
{
    public class ArtikelController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,GTIN,Bestand,Nettoverkaufspreis,LieferantId,WarengruppeId")] Artikel artikel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,GTIN,Bestand,Nettoverkaufspreis,LieferantId,WarengruppeId")] Artikel artikel)
        {
            if (ModelState.IsValid)
            {
