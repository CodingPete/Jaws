...
namespace Dashboard.Controllers
{
    public class LieferantController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Hausnummer,Postleitzahl,Ort,Telefon,Mobil,Email,IBAN,BIC")] Lieferant lieferant)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Hausnummer,Postleitzahl,Ort,Telefon,Mobil,Email,IBAN,BIC")] Lieferant lieferant)
        {
            if (ModelState.IsValid)
            {
